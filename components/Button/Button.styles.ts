...
export const baseButton = tv({
  base: 'text-white inline-flex items-center justify-center font-semibold focus:outline-none focus:ring-2 transition-all duration-300 ease-in-out rounded-md border',
  variants: {
    size: {
